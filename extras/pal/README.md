...
A PAL is provided to allow integration with *Zephyr OS*. The [example application](https://github.com/Infineon/optiga-trust-m-zephyr) shows the necessary steps to get started.
