 ...
 */
static size_t
encode_der_integer(const uint8_t *data, size_t data_len, uint8_t *out_buf, size_t out_buf_len) {
...
bool ecdsa_rs_to_asn1_integers(
    const uint8_t *r,
    const uint8_t *s,
    size_t rs_len,
    uint8_t *asn_sig,
...
bool ecdsa_rs_to_asn1_signature(
    const uint8_t *r,
    const uint8_t *s,
    size_t rs_len,
    uint8_t *asn_sig,
 ...
 */
static size_t
decode_asn1_uint(const uint8_t *asn1, size_t asn1_len, uint8_t *out_int, size_t *out_int_len) {
